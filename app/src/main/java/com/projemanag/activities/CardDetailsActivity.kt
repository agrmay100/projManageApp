...
import com.projemanag.adapters.CardMemberListItemAdapter
...
//        setFonts()
    ...
    private fun getIntentData() {
        ...
        if (intent.hasExtra(Constants.BOARD_MEMBERS_LIST)) {
            mMemberDetailList = intent.getParcelableArrayListExtra<Parcelable>(Constants.BOARD_MEMBERS_LIST) as ArrayList<User>
        }
    }
